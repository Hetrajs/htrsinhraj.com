...
sr.reveal('.work_filters, .work_container, .work_card', {delay:800, origin:'bottom'})
sr.reveal('.testimonial_container', {delay:700, origin:'bottom'})
sr.reveal('.contact_container, .contact_content', {delay:700, origin:'bottom'})
